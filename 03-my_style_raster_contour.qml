...
<qgis version="2.6.1-Brighton" minimumScale="500" maximumScale="1e+06" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{77e13999-7adc-454f-a012-5f6a06f3e551}">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  ELEV  like  '%00' or  ELEV  like  '%50' THEN ELEV END"/>
